...
//  Split App
//
//  Created by StellaShen on 2022/4/21.
//
...
class TwitterAPICaller: BDBOAuth1SessionManager {
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "jasrcUcXkdIF6G9X71QYrHJPV", consumerSecret: "XtxceuTb3PuKI2St1wNrKaAd7LffnhGdbGRnXXmsrgBS3AspEr")
    var loginSuccess: (() -> ())?
